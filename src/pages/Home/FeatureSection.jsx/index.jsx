...
//   // Hooks for scroll-triggered slide animations
//   const [img1Ref, img1Visible] = useScrollReveal();
//   const [card1Ref, card1Visible] = useScrollReveal({ threshold: 0.3 });
//   const [card2Ref, card2Visible] = useScrollReveal();
//   const [img2Ref, img2Visible] = useScrollReveal({ threshold: 0.3 });
...
//         <h2 className="font-heading text-[36px] md:text-[64px] font-bold uppercase text-black mb-4 md:mb-[20px] leading-tight">
//           Real Art.  Real Fast.
//         </h2>
...
//             img1Visible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-16'
//           }`}
//         >
//           <img 
//             src="https://placehold.co/800x500/eaeaea/a3a3a3?text=Tattoo+Sleeve+Image" 
...
//         <div 
//           ref={card1Ref}
//           className={`md:col-span-4 h-[500px] bg-black rounded-[30px] p-6 md:p-10 flex flex-col justify-end transition-all duration-1000 delay-100 ease-out ${
//             card1Visible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-16'
//           }`}
//         >
...
//             card2Visible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-16'
//           }`}
//         >
...
//         <div 
//           ref={img2Ref}
//           className={`md:col-span-8 h-[500px] rounded-[30px] overflow-hidden transition-all duration-1000 delay-100 ease-out ${
//             img2Visible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-16'
//           }`}
//         >
//           <img 
//             src="https://placehold.co/800x500/eaeaea/a3a3a3?text=Peeling+Tattoo+Image" 
